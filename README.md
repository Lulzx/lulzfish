...
- Search prototype: alpha-beta + iterative deepening root search + bounded check extension + TT bounds/hash move ordering + repetition scoring + QSearch with bounded quiet checks + Null Move + SEE + History/Killers
